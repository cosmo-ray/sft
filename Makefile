#############################################################################
# Makefile for building: SFT
# Generated by qmake (3.0) (Qt 5.1.0) on: Mon Jul 8 19:14:29 2013
# Project:  videowidget.pro
# Template: app
# Command: /usr/bin/qmake-qt5 -o Makefile videowidget.pro
#############################################################################
...
INCPATH       = -I/usr/lib/qt/mkspecs/linux-g++ -I. -I/usr/include/qt -I/usr/include/qt/QtMultimediaWidgets -I/usr/include/qt/QtMultimedia -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtNetwork -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I.
LINK          = g++
LFLAGS        = -Wl,-O1,--sort-common,--as-needed,-z,relro -Wl,-O1 -Wl,-rpath-link,/usr/lib
LIBS          = $(SUBLIBS) -lQt5MultimediaWidgets -lQt5Multimedia -lQt5Widgets -lQt5Network -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = main.cpp \
		...
		syllabemanager.cpp \
		sentence.cpp \
		parolestextedit.cpp moc_videoplayer.cpp
OBJECTS       = main.o \
		videoplayer.o \
		syllabe.o \
		syllabemanager.o \
...
Makefile: videowidget.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/shell-unix.conf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile videowidget.pro
...
dist: 
	@test -d .tmp/SFT1.0.0 || mkdir -p .tmp/SFT1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/SFT1.0.0/ && $(COPY_FILE) --parents videoplayer.h syllabe.h syllabemanager.h sentence.h parolestextedit.h .tmp/SFT1.0.0/ && $(COPY_FILE) --parents main.cpp videoplayer.cpp syllabe.cpp syllabemanager.cpp sentence.cpp parolestextedit.cpp .tmp/SFT1.0.0/ && (cd `dirname .tmp/SFT1.0.0` && $(TAR) SFT1.0.0.tar SFT1.0.0 && $(COMPRESS) SFT1.0.0.tar) && $(MOVE) `dirname .tmp/SFT1.0.0`/SFT1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/SFT1.0.0
...
compiler_moc_header_make_all: moc_videoplayer.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_videoplayer.cpp
moc_videoplayer.cpp: /usr/include/qt/QtMultimedia/qmediaplayer.h \
		...
		/usr/include/qt/QtGui/QAbstractTextDocumentLayout \
...
syllabe.o: syllabe.cpp syllabe.h \
		/usr/include/qt/QtCore/QtGlobal \
		/usr/include/qt/QtCore/qglobal.h \
		/usr/include/qt/QtCore/qconfig.h \
		/usr/include/qt/QtCore/qfeatures.h \
		...
		/usr/include/qt/QtCore/qset.h \
		/usr/include/qt/QtCore/qcontiguouscache.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o syllabe.o syllabe.cpp

syllabemanager.o: syllabemanager.cpp /usr/include/qt/QtCore/QFile \
		/usr/include/qt/QtCore/qfile.h \
		/usr/include/qt/QtCore/qfiledevice.h \
		/usr/include/qt/QtCore/qiodevice.h \
		/usr/include/qt/QtCore/qglobal.h \
		...
		/usr/include/qt/QtCore/QString \
		sentence.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o syllabemanager.o syllabemanager.cpp
...
sentence.o: sentence.cpp sentence.h \
		...
		/usr/include/qt/QtCore/qset.h \
		/usr/include/qt/QtCore/qcontiguouscache.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o sentence.o sentence.cpp

parolestextedit.o: parolestextedit.cpp parolestextedit.h \
		/usr/include/qt/QtWidgets/QTextEdit \
		/usr/include/qt/QtWidgets/qtextedit.h \
		/usr/include/qt/QtWidgets/qabstractscrollarea.h \
		/usr/include/qt/QtWidgets/qframe.h \
		...
		/usr/include/qt/QtGui/qfontdatabase.h \
		/usr/include/qt/QtCore/QDebug
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o parolestextedit.o parolestextedit.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/doc/qt/examples/multimediawidgets/videowidget || mkdir -p $(INSTALL_ROOT)/usr/share/doc/qt/examples/multimediawidgets/videowidget
	-$(INSTALL_PROGRAM) "$(QMAKE_TARGET)" "$(INSTALL_ROOT)/usr/share/doc/qt/examples/multimediawidgets/videowidget/$(QMAKE_TARGET)"
	-$(STRIP) "$(INSTALL_ROOT)/usr/share/doc/qt/examples/multimediawidgets/videowidget/$(QMAKE_TARGET)"

uninstall_target: FORCE
	-$(DEL_FILE) "$(INSTALL_ROOT)/usr/share/doc/qt/examples/multimediawidgets/videowidget/$(QMAKE_TARGET)"
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/doc/qt/examples/multimediawidgets/videowidget/ 
